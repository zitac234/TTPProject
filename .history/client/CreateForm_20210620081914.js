...
export default function CreateForm (props) {
      ...
      let[ numberOfSentence, numberOfWord, numberOfCharacter, numberOfParagraph,counted] =  [0, 0, 0, 0,0]
      // let[setenceDelimeter] = [ /[!\.\?]/]
...
const  count = (string, delimeter)=>{
      let textSplit = string.split(delimeter)
      let stringArray =  textSplit.filter(str => str && str.trim())
