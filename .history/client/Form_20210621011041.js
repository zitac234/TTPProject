...
export default function Form(props){
      let numberOfSentence =( props.counted(props.text,   /[!\.\?]/)[0] || 0)
      let numberOfWord = (props.counted(props.text,   ' ')[0] || 0)
      console.log('numberOfWord ', props.counted(props.text,   ' '))
            ...
            <div>
                  ...
                  <div className = 'split right'>
                        <div className = 'centered'>
                              ...
                              <h3>Searched Result:<p id =  'result'></p></h3> {/*word serch result */}
                        </div>
                  </div>
            </div>
      )
